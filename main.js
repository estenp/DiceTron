// elm-watch hot {"version":"1.2.0-beta.4","targetName":"My target name","webSocketPort":63503}
"use strict";
(() => {
								...
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{
											...
											quantity: $author$project$Try$Two,
											tryToBeat: _Utils_Tuple2($author$project$Try$Two, $author$project$Try$Twos),
											turnStatus: $author$project$Main$Pulled($author$project$Main$HadIt),
								...
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{
											...
											quantity: $author$project$Try$Two,
											tryToBeat: _Utils_Tuple2($author$project$Try$Two, $author$project$Try$Twos),
											turnStatus: $author$project$Main$Pulled($author$project$Main$Lie),
											value: $author$project$Try$Twos
										}),
									$elm$core$Platform$Cmd$none);
							}
...
var $author$project$Main$view = function (model) {
	var trySelects = _List_fromArray(
		[
			A3($author$project$Main$viewPassTry, model.quantity, model.value, model.tryToBeat)
		]);
	var tryHistory = A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
