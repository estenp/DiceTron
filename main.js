...
var $author$project$Main$my_players = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2(
			1,
			{hp: 1, id: 1, maxHp: 5, name: 'Rick'}),
			_Utils_Tuple2(
			2,
			{hp: 5, id: 2, maxHp: 5, name: 'Pat'}),
			_Utils_Tuple2(
			3,
			{hp: 5, id: 3, maxHp: 5, name: 'Esten'})
		]));
	...
	return _Utils_Tuple2(
		{
			...
			turnStatus: $author$project$Main$Fresh,
...
var $author$project$Main$Dice = function (a) {
	return {$: 'Dice', a: a};
};
var $author$project$Main$GameEvent = function (a) {
	return {$: 'GameEvent', a: a};
};
...
var $author$project$Try$getBestOfAKind = function (dict) {
	var wild_count = A2(
		$elm$core$Maybe$withDefault,
		0,
		A2($elm$core$Dict$get, 1, dict));
	return (wild_count === 5) ? _Utils_Tuple2($author$project$Try$Five, $author$project$Try$Sixes) : $author$project$Try$encode(
...
var $author$project$Try$decode = function (_try) {
	return _Utils_Tuple2(
		$author$project$Try$decodeQuantity(_try.a),
		$author$project$Try$decodeFace(_try.b));
};
var $author$project$Try$dictionary = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2(
			_Utils_Tuple2(
				$author$project$Try$decodeQuantity($author$project$Try$Two),
				$author$project$Try$decodeFace($author$project$Try$Twos)),
			1),
			_Utils_Tuple2(
			_Utils_Tuple2(
				$author$project$Try$decodeQuantity($author$project$Try$Two),
				$author$project$Try$decodeFace($author$project$Try$Threes)),
			2),
			_Utils_Tuple2(
			_Utils_Tuple2(
				$author$project$Try$decodeQuantity($author$project$Try$Two),
				$author$project$Try$decodeFace($author$project$Try$Fours)),
			3),
			_Utils_Tuple2(
			_Utils_Tuple2(
				$author$project$Try$decodeQuantity($author$project$Try$Two),
				$author$project$Try$decodeFace($author$project$Try$Fives)),
			4),
			_Utils_Tuple2(
			_Utils_Tuple2(
				$author$project$Try$decodeQuantity($author$project$Try$Two),
				$author$project$Try$decodeFace($author$project$Try$Sixes)),
			5),
			_Utils_Tuple2(
			_Utils_Tuple2(
				$author$project$Try$decodeQuantity($author$project$Try$Three),
				$author$project$Try$decodeFace($author$project$Try$Twos)),
			6),
			_Utils_Tuple2(
			_Utils_Tuple2(
			...
			_Utils_Tuple2(
			_Utils_Tuple2(
				$author$project$Try$decodeQuantity($author$project$Try$Four),
				$author$project$Try$decodeFace($author$project$Try$Twos)),
			11),
			_Utils_Tuple2(
			_Utils_Tuple2(
			...
			_Utils_Tuple2(
			_Utils_Tuple2(
				$author$project$Try$decodeQuantity($author$project$Try$Five),
				$author$project$Try$decodeFace($author$project$Try$Twos)),
			16),
			_Utils_Tuple2(
			_Utils_Tuple2(
...
var $author$project$Try$eval = function (_try) {
	return A2(
		$elm$core$Maybe$withDefault,
		1,
		A2(
...
var $author$project$Try$getLastTry = function (tryHistory) {
	return A3(
		...
		A2(
			...
			$elm$core$List$reverse(tryHistory)));
};
...
var $author$project$Try$mustPass = function (receivedTry) {
	var receivedTryVal = $author$project$Try$eval(receivedTry);
	var nextTry = $elm$core$List$head(
		A2(
			$elm$core$List$map,
			...
			A2(
				...
				function (t) {
					return _Utils_eq(t.b, receivedTryVal + 1);
				},
				$elm$core$Dict$toList($author$project$Try$dictionary))));
	if (nextTry.$ === 'Just') {
		var tup = nextTry.a;
		return $elm$core$Maybe$Just(
			$author$project$Try$encode(tup));
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $author$project$Try$dieGenerator = A2(
	$elm$random$Random$uniform,
	$author$project$Try$Wilds,
	_List_fromArray(
		[$author$project$Try$Twos, $author$project$Try$Threes, $author$project$Try$Fours, $author$project$Try$Fives, $author$project$Try$Sixes]));
		...
		while (true) {
			switch (msg.$) {
				case 'Dice':
					...
					if (subMsg.$ === 'RollClick') {
						...
						switch (_v2.$) {
							case 'Pulled':
								return _Utils_Tuple2(
									...
									A2(
										$elm$random$Random$generate,
										A2($elm$core$Basics$composeL, $author$project$Main$Dice, $author$project$Main$NewRoll),
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{roll: roll, turnStatus: $author$project$Main$Rolled}),
							$elm$core$Platform$Cmd$none);
					}
				case 'ViewState':
					var subMsg = msg.a;
				...
				default:
					...
					switch (subMsg.$) {
						case 'Pull':
							var passedTry = $author$project$Try$getLastTry(model.tryHistory);
							var currentRollTry = $author$project$Try$assessRoll(
								_Utils_ap(
									model.roll,
									A2($elm$core$List$repeat, model.tableWilds, $author$project$Try$Wilds)));
							var pullResult = A2($author$project$Try$compare, currentRollTry, passedTry);
							if (pullResult.$ === 'HadIt') {
								...
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{
											...
											quantity: $author$project$Try$Two,
											tryToBeat: _Utils_Tuple2($author$project$Try$Two, $author$project$Try$Twos),
											turnStatus: $author$project$Main$Pulled($author$project$Try$HadIt),
								...
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{
											...
											quantity: $author$project$Try$Two,
											tryToBeat: _Utils_Tuple2($author$project$Try$Two, $author$project$Try$Twos),
											turnStatus: $author$project$Main$Pulled($author$project$Try$Lie),
											value: $author$project$Try$Twos
										}),
									$elm$core$Platform$Cmd$none);
							}
								...
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{
											...
											tryToBeat: _try,
											turnStatus: $author$project$Main$Pending,
...
var $author$project$Tailwind$Utilities$bg_secondary = A2($rtfeldman$elm_css$Css$property, 'background-color', '#dfeee3ff');
...
var $author$project$Tailwind$Utilities$text_destruct = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			A2($rtfeldman$elm_css$Css$property, '--tw-text-opacity', '1'),
			A2($rtfeldman$elm_css$Css$property, 'color', 'rgba(142, 74, 73, var(--tw-text-opacity))')
		]));
var $author$project$Main$inputBaseStyles = _List_fromArray(
	[$author$project$Tailwind$Utilities$border_solid, $author$project$Tailwind$Utilities$border_2, $author$project$Tailwind$Utilities$px_4, $author$project$Tailwind$Utilities$py_2, $author$project$Tailwind$Utilities$bg_secondary, $author$project$Tailwind$Utilities$rounded_md, $author$project$Tailwind$Utilities$text_destruct]);
		...
		_List_fromArray(
			[
				...
				[
					...
					_List_fromArray(
						[$author$project$Tailwind$Utilities$w_52])),
...
var $author$project$Player$getName = F2(
	function (players, id) {
		return function ($) {
			...
			A2($author$project$Player$getPlayer, players, id));
	});
...
var $author$project$Tailwind$Utilities$globalStyles = _List_fromArray(
	[
		...
		_List_fromArray(
			[
				A2($rtfeldman$elm_css$Css$property, 'font-family', '\'Space Grotesk\', sans-serif'),
		...
		_List_fromArray(
			[
				...
				A2($rtfeldman$elm_css$Css$property, 'color', '#a1a1aa')
			])),
		A2(
		$rtfeldman$elm_css$Css$Global$selector,
...
var $author$project$Main$header_ = A2(
	...
	_List_fromArray(
		[$author$project$Tailwind$Utilities$grid, $author$project$Tailwind$Utilities$grid_cols_header, $author$project$Tailwind$Utilities$mb_10]));
...
var $author$project$Tailwind$Utilities$bg_primary = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
...
var $author$project$Tailwind$Utilities$rounded_br = A2($rtfeldman$elm_css$Css$property, 'border-bottom-right-radius', '0.25rem');
...
var $author$project$Tailwind$Utilities$w_24 = A2($rtfeldman$elm_css$Css$property, 'width', '6rem');
var $author$project$Main$logo = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[$author$project$Tailwind$Utilities$w_24, $author$project$Tailwind$Utilities$h_24, $author$project$Tailwind$Utilities$flex, $author$project$Tailwind$Utilities$justify_center, $author$project$Tailwind$Utilities$items_center, $author$project$Tailwind$Utilities$text_4xl, $author$project$Tailwind$Utilities$font_bold, $author$project$Tailwind$Utilities$bg_primary, $author$project$Tailwind$Utilities$rounded_br, $author$project$Tailwind$Utilities$shadow_md, $author$project$Tailwind$Utilities$bg_gradient_to_br, $author$project$Tailwind$Utilities$from_primary, $author$project$Tailwind$Utilities$to_destruct]))
		]),
	_List_fromArray(
		[
			$rtfeldman$elm_css$Html$Styled$text('D T')
		]));
...
var $author$project$Tailwind$Utilities$text_tertiary = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			A2($rtfeldman$elm_css$Css$property, '--tw-text-opacity', '1'),
...
var $author$project$Main$stats_ = $rtfeldman$elm_css$Html$Styled$div(
	_List_fromArray(
		[
			...
			$rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
				[$author$project$Tailwind$Utilities$flex, $author$project$Tailwind$Utilities$justify_around, $author$project$Tailwind$Utilities$p_4, $author$project$Tailwind$Utilities$shadow_sm, $author$project$Tailwind$Utilities$bg_secondary, $author$project$Tailwind$Utilities$rounded_b, $author$project$Tailwind$Utilities$shadow_md, $author$project$Tailwind$Utilities$text_tertiary]))
		]));
...
var $author$project$Tailwind$Utilities$bg_destruct = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			A2($rtfeldman$elm_css$Css$property, '--tw-bg-opacity', '1'),
			A2($rtfeldman$elm_css$Css$property, 'background-color', 'rgba(142, 74, 73, var(--tw-bg-opacity))')
		]));
var $author$project$Tailwind$Utilities$bg_exclaim = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			A2($rtfeldman$elm_css$Css$property, '--tw-bg-opacity', '1'),
			A2($rtfeldman$elm_css$Css$property, 'background-color', 'rgba(224, 144, 93, var(--tw-bg-opacity))')
		]));
var $author$project$Tailwind$Utilities$bg_success = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			A2($rtfeldman$elm_css$Css$property, '--tw-bg-opacity', '1'),
			A2($rtfeldman$elm_css$Css$property, 'background-color', 'rgba(44, 165, 141, var(--tw-bg-opacity))')
		]));
var $author$project$Tailwind$Utilities$border_b_2 = A2($rtfeldman$elm_css$Css$property, 'border-bottom-width', '2px');
var $author$project$Tailwind$Utilities$border_success = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			A2($rtfeldman$elm_css$Css$property, '--tw-border-opacity', '1'),
			A2($rtfeldman$elm_css$Css$property, 'border-color', 'rgba(44, 165, 141, var(--tw-border-opacity))')
		]));
var $author$project$Tailwind$Utilities$h_4 = A2($rtfeldman$elm_css$Css$property, 'height', '1rem');
...
var $author$project$Player$view = F2(
	function (currentTurn, player) {
		var maxHp = $elm$core$String$fromInt(player.maxHp);
		var hp = $elm$core$String$fromInt(player.hp);
		var healthPercent = (player.hp / player.maxHp) | 0;
			...
			return A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$css(
						_List_fromArray(
							[bgStyle, $author$project$Tailwind$Utilities$w_8, $author$project$Tailwind$Utilities$h_4, $author$project$Tailwind$Utilities$border_b_2, $author$project$Tailwind$Utilities$border_success]))
					]),
				_List_Nil);
		};
		var healthDiff = player.maxHp - player.hp;
		var healthBg = function (h) {
			return (_Utils_cmp(h, player.hp) < 1) ? ((_Utils_cmp(h / player.maxHp, 1 / 5) < 1) ? $author$project$Tailwind$Utilities$bg_destruct : ((_Utils_cmp(h / player.maxHp, 3 / 5) < 1) ? $author$project$Tailwind$Utilities$bg_exclaim : $author$project$Tailwind$Utilities$bg_success)) : $author$project$Tailwind$Utilities$bg_secondary;
		};
		var healthStack = A2(
			$elm$core$List$map,
			healthBg,
...
var $author$project$Tailwind$Utilities$text_secondary = A2($rtfeldman$elm_css$Css$property, 'color', '#dfeee3ff');
		...
		_List_fromArray(
			[
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$author$project$Tailwind$Utilities$w_40,
						A2(
							$elm$core$List$cons,
							$author$project$Tailwind$Utilities$inline_block,
							A2(
								...
								A2(
									$elm$core$List$cons,
									$author$project$Tailwind$Utilities$m_2,
									_List_fromArray(
										[$author$project$Tailwind$Utilities$text_9xl, $author$project$Tailwind$Utilities$border_4, $author$project$Tailwind$Utilities$rounded_2xl]))))))),
				$rtfeldman$elm_css$Html$Styled$Attributes$css(
				_List_fromArray(
					[
...
var $author$project$Try$getPassableTrys = function (_try) {
	var tryValue = $author$project$Try$eval(_try);
	var betterTrys = $elm$core$Dict$keys(
		A2(
			$elm$core$Dict$filter,
			F2(
				function (_v1, v) {
					return _Utils_cmp(v, tryValue) > 0;
				}),
			$author$project$Try$dictionary));
	var groupedTrys = A2($elm_community$dict_extra$Dict$Extra$groupBy, $elm$core$Tuple$first, betterTrys);
	var groupedDict = A2(
		$elm$core$Dict$map,
		F2(
			function (_v0, v) {
...
var $author$project$Main$quantityOptions = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2(
			$author$project$Try$decodeQuantity($author$project$Try$One),
			A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('one')
					]))),
			_Utils_Tuple2(
			$author$project$Try$decodeQuantity($author$project$Try$Two),
			A2(
			...
			A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$value('3')
					]),
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('three')
					]))),
			_Utils_Tuple2(
			$author$project$Try$decodeQuantity($author$project$Try$Four),
			A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$value('4')
					]),
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('four')
					]))),
			_Utils_Tuple2(
			$author$project$Try$decodeQuantity($author$project$Try$Five),
			A2(
	...
	_List_fromArray(
		[
			...
			A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('threes')
					]))),
			_Utils_Tuple2(
			$author$project$Try$decodeFace($author$project$Try$Fours),
			A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('fours')
					]))),
			_Utils_Tuple2(
			$author$project$Try$decodeFace($author$project$Try$Fives),
			A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('fives')
					]))),
			_Utils_Tuple2(
			$author$project$Try$decodeFace($author$project$Try$Sixes),
			A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$value('6')
					]),
				_List_fromArray(
					[
	...
	function (_try, quantity) {
		...
		var vOptions = A2(
			...
			A2(
				...
				A2(
					$elm$core$Dict$get,
					$author$project$Try$decodeQuantity(quantity),
					passableTrysDict)));
		var passableQuants = $elm$core$Dict$keys(passableTrysDict);
		var qOptions = A2(
			$elm$core$List$map,
			function (o) {
				return A2(
	...
	function (quantity, val, tryToBeat) {
		var changeValue = A2(
			...
			A2(
				...
				A2(
					$elm$core$Basics$composeL,
					A2($elm$core$Basics$composeL, $author$project$Main$ViewState, $author$project$Main$ChangeValue),
					$author$project$Try$encodeFace),
				$elm$core$Maybe$withDefault(2)),
			$elm$core$String$toInt);
		var changeQuantity = A2(
			$elm$core$Basics$composeL,
			A2(
				$elm$core$Basics$composeL,
				A2(
					$elm$core$Basics$composeL,
					A2($elm$core$Basics$composeL, $author$project$Main$ViewState, $author$project$Main$ChangeQuantity),
				...
				[
					...
					_List_fromArray(
						[
							...
							A2($elm$core$Basics$composeL, $author$project$Main$GameEvent, $author$project$Main$Pass)(
...
var $author$project$Main$view = function (model) {
			...
			function (tup) {
				return A2(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text(
							$TSFoster$elm_tuple_extra$Tuple3$second(tup) + (' -> ' + ($TSFoster$elm_tuple_extra$Tuple3$first(tup) + (' ' + ($TSFoster$elm_tuple_extra$Tuple3$third(tup) + 'hp')))))
						]));
			},
			A2(
				$elm$core$List$map,
				A3(
					...
					$author$project$Player$getName(model.players),
	...
	var playerStats = $author$project$Main$stats_(
		A2(
			$elm$core$List$map,
			$author$project$Player$view(model.whosTurn),
			A2(
				$elm$core$List$map,
				$elm$core$Tuple$second,
						...
						return $author$project$Main$mainContainer_(
							_List_fromArray(
								[
									...
									_List_Nil,
									_List_fromArray(
										[$author$project$Main$logo, playerStats])),
									tryHistory,
									rollButtons
								]));
					case 'Rolled':
			...
			[
				...
				'Game over.' + (A2(
					...
					A2(
						$elm$core$Maybe$withDefault,
						0,
						$folkertdev$elm_deque$Deque$first(model.activePlayers))) + ' wins!'))
			]));
};
