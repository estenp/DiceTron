...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			{consoleState: $author$project$Main$initConsoleState, gameState: $author$project$Main$initGameState, key: key, url: url},
...
var $author$project$Console$addEntries = F2(
	function (console, entries) {
		return _Utils_update(
			console,
			{
				consoleHistory: _Utils_ap(console.consoleHistory, entries),
				consoleValue: ''
			});
	});
...
var $author$project$Game$decodeAction = function (action) {
	switch (action.$) {
		case 'Pull':
			return 'pull';
		case 'Pass':
...
var $author$project$Game$HadIt = {$: 'HadIt'};
var $author$project$Game$Lie = {$: 'Lie'};
var $author$project$Game$Looked = {$: 'Looked'};
var $author$project$Game$Pulled = function (a) {
	return {$: 'Pulled', a: a};
};
var $author$project$Game$Received = {$: 'Received'};
var $author$project$Game$Rolled = {$: 'Rolled'};
var $author$project$Game$isValidAction = F2(
	function (rollState, action) {
		switch (action.$) {
			case 'Pull':
				return _Utils_eq(rollState, $author$project$Game$Received);
			case 'Look':
				return _Utils_eq(rollState, $author$project$Game$Received);
			case 'Pass':
				return _Utils_eq(rollState, $author$project$Game$Received) || (_Utils_eq(rollState, $author$project$Game$Looked) || _Utils_eq(rollState, $author$project$Game$Rolled));
			default:
				return _Utils_eq(rollState, $author$project$Game$Init) || (_Utils_eq(rollState, $author$project$Game$Looked) || (_Utils_eq(
					rollState,
					$author$project$Game$Pulled($author$project$Game$Lie)) || _Utils_eq(
					rollState,
...
var $author$project$Main$mergeConsoleState = F2(
	function (model, console) {
		return _Utils_update(
			model,
			{consoleState: console});
	});
var $author$project$Main$mergeGameState = F2(
	function (model, game) {
		return _Utils_update(
			model,
			{gameState: game});
...
var $author$project$Try$encodeFace = function (die) {
	switch (die) {
		case 1:
			return $elm$core$Maybe$Just($author$project$Try$Wilds);
		case 2:
			return $elm$core$Maybe$Just($author$project$Try$Twos);
		case 3:
			return $elm$core$Maybe$Just($author$project$Try$Threes);
		case 4:
			return $elm$core$Maybe$Just($author$project$Try$Fours);
		case 5:
			return $elm$core$Maybe$Just($author$project$Try$Fives);
		case 6:
			return $elm$core$Maybe$Just($author$project$Try$Sixes);
		default:
			return $elm$core$Maybe$Nothing;
	}
};
...
var $author$project$Try$encodeQuantity = function (quant) {
	switch (quant) {
		case 1:
			return $elm$core$Maybe$Just($author$project$Try$One);
		case 2:
			return $elm$core$Maybe$Just($author$project$Try$Two);
		case 3:
			return $elm$core$Maybe$Just($author$project$Try$Three);
		case 4:
			return $elm$core$Maybe$Just($author$project$Try$Four);
		case 5:
			return $elm$core$Maybe$Just($author$project$Try$Five);
		default:
			return $elm$core$Maybe$Nothing;
	}
};
	...
	return A2(
		...
		function (quantity) {
			return A2(
				$elm$core$Maybe$map,
				function (face) {
					return _Utils_Tuple2(quantity, face);
				},
...
var $author$project$Try$toScore = function (_try) {
	return A2(
		$elm$core$Dict$get,
...
var $author$project$Game$Pull = {$: 'Pull'};
var $author$project$Game$encodeAction = function (action) {
	switch (action) {
		case 'pull':
			return $elm$core$Result$Ok($author$project$Game$Pull);
		case 'pass':
			return $elm$core$Result$Ok(
		...
		switch (msg.$) {
			...
			case 'VisibilityToggled':
				return _Utils_Tuple2(
					_Utils_update(
						console,
						{consoleIsVisible: !console.consoleIsVisible}),
					_Utils_Tuple2(game, $elm$core$Platform$Cmd$none));
			default:
				var consoleInput = msg.a;
				var _v2 = $elm$core$String$words(consoleInput);
				if (_v2.b) {
					var x = _v2.a;
					var xs = _v2.b;
					switch (x) {
						case '/c':
							return _Utils_Tuple2(
								A2(
									...
									_List_fromArray(
										[
											'[chat] ' + A2($elm$core$String$dropLeft, 2, consoleInput)
										])),
								_Utils_Tuple2(game, $elm$core$Platform$Cmd$none));
						case 'try':
							return _Utils_Tuple2(
										...
										default:
											return _Utils_Tuple2(
												A2(
													...
													console,
													_List_fromArray(
														[consoleInput, 'Command not recognized.'])),
												_Utils_Tuple2(game, $elm$core$Platform$Cmd$none));
									}
								} else {
									return _Utils_Tuple2(
...
var $author$project$Console$Change = function (a) {
	return {$: 'Change', a: a};
};
var $author$project$Main$ConsoleMsg = function (a) {
	return {$: 'ConsoleMsg', a: a};
};
	...
	[
		...
		_List_fromArray(
			[
				...
				A2($rtfeldman$elm_css$Css$property, 'font-variation-settings', 'normal')
			])),
		A2(
		$rtfeldman$elm_css$Css$Global$selector,
		'body',
		...
		_List_fromArray(
			[
				...
				A2($rtfeldman$elm_css$Css$property, 'font-feature-settings', 'inherit'),
				A2($rtfeldman$elm_css$Css$property, 'font-variation-settings', 'inherit'),
		...
		_List_fromArray(
			[
				...
				A2($rtfeldman$elm_css$Css$property, '--tw-gradient-from-position', ' '),
				A2($rtfeldman$elm_css$Css$property, '--tw-gradient-via-position', ' '),
				A2($rtfeldman$elm_css$Css$property, '--tw-gradient-to-position', ' '),
	...
	return $rtfeldman$elm_css$Css$batch(
		_List_fromArray(
			[
				...
				$elm$core$Maybe$Nothing,
				color),
				A2($rtfeldman$elm_css$Css$property, '--tw-shadow', 'var(--tw-shadow-colored)')
			]));
};
...
var $author$project$Common$logo = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$author$project$Tailwind$Utilities$w_32,
					$author$project$Tailwind$Utilities$h_32,
					...
					$author$project$Tailwind$Utilities$m_4,
					$author$project$Tailwind$Utilities$shadow_color($author$project$Tailwind$Theme$purple_200),
					$author$project$Tailwind$Utilities$text_8xl,
					$author$project$Tailwind$Utilities$text_color($author$project$Tailwind$Theme$black_100),
					$author$project$Tailwind$Utilities$font_bold,
					$author$project$Tailwind$Utilities$border_4,
					$author$project$Tailwind$Utilities$border_color($author$project$Tailwind$Theme$black_100),
			...
			$rtfeldman$elm_css$Html$Styled$Attributes$class('logo logo-container')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$id('logo')
				]),
			_List_fromArray(
				[
...
var $author$project$Tailwind$Theme$purple_100 = A5($matheus23$elm_tailwind_modules_base$Tailwind$Color$Color, 'rgb', '200', '184', '219', $matheus23$elm_tailwind_modules_base$Tailwind$Color$ViaVariable);
						...
						[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[$author$project$Tailwind$Utilities$flex, $author$project$Tailwind$Utilities$gap_4, $author$project$Tailwind$Utilities$items_start]))
								]),
							_List_fromArray(
								[
							...
							[
								...
								_List_fromArray(
									[
										...
										$rtfeldman$elm_css$Html$Styled$Events$onInput(messages.onInput),
										$author$project$Console$onEnter(
										messages.onEnter(model.consoleValue)),
...
var $author$project$Face$view = function (die) {
	...
	var className = isWild ? 'face wild' : 'face';
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Tailwind$Utilities$text_9xl,
						$author$project$Tailwind$Utilities$border_4,
						$author$project$Tailwind$Utilities$rounded_2xl,
						$author$project$Tailwind$Utilities$bg_color($author$project$Tailwind$Theme$white),
						$author$project$Tailwind$Utilities$text_color($author$project$Tailwind$Theme$black_100)
		...
		_List_fromArray(
			[
				isWild ? $rtfeldman$elm_css$Html$Styled$text('•') : $rtfeldman$elm_css$Html$Styled$text(
...
var $author$project$Try$getPassableTrys = function (_try) {
	var tryValue = function () {
		var _v2 = $author$project$Try$toScore(_try);
		if (_v2.$ === 'Just') {
			var value = _v2.a;
			return value;
		} else {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$rtfeldman$elm_css$Html$Styled$Attributes$css(
				_List_fromArray(
					[$author$project$Tailwind$Utilities$justify_self_center, $author$project$Tailwind$Utilities$mt_4, $author$project$Tailwind$Utilities$overflow_auto]))
			]),
		A2(
			$elm$core$List$map,
			function (turn) {
		...
		[
			...
			_Utils_ap(
				_List_fromArray(
					[
						$author$project$Tailwind$Utilities$flex,
						$author$project$Tailwind$Utilities$justify_around,
						$author$project$Tailwind$Utilities$p_4,
						$author$project$Tailwind$Utilities$text_color($author$project$Tailwind$Theme$black_100),
						$author$project$Tailwind$Utilities$gap_8
					]),
				_Utils_ap(
...
var $author$project$Player$viewStats = F2(
	function (players, current) {
		return $author$project$Common$stats_(
			A2(
				$elm$core$List$map,
				$author$project$Player$view(current),
				A2(
					$elm$core$List$map,
					$elm$core$Tuple$second,
					$elm$core$Dict$toList(players))));
	});
var $author$project$Main$view = function (model) {
	...
	var playerStats = A2($author$project$Player$viewStats, gameState.players, gameState.whosTurn);
	var table = A2(
		$rtfeldman$elm_css$Html$Styled$map,
